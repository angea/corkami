; a PE with appended data hidden by an extra almost virtual section
...
istruc IMAGE_SECTION_HEADER
    ...
    at IMAGE_SECTION_HEADER.SizeOfRawData,    dd 1 ; it could be null, but making it non-empty will make the last byte of the file 'virtual'
...
Msg db " * appended data, hidden by an extra section", 0ah, 0
_d
