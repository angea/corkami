	...
	StringFileInfo:
		...
		StringTable:
			...
			WIDE '040904b0' ; required correct
				align 4, db 0
			;children
			__string 'FileVersion', '' ; required or won't be displayed by explorer
			__string 'FileDescription', 'a PE with version information'
			__string 'LegalCopyright', ''
			
			__string 'custom', 'some value'
				;other possible standard values
				;StringFileInfo
				;Comments
				;CompanyName
				;FileVersion
