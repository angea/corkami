...
helloworld db "simple TLS CallBack: Hello World! ", 0ah, 0
_d
...
Image_Tls_Directory32:
    StartAddressOfRawData dd VDELTA + Characteristics
    EndAddressOfRawData   dd VDELTA + Characteristics
    AddressOfIndex        dd VDELTA + Characteristics
    AddressOfCallBacks    dd VDELTA + SizeOfZeroFill
    SizeOfZeroFill        dd VDELTA + tls
