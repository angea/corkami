; file using a fake push ret, but actually a push/ret16
...
;ntdll
    dd ntdll.dll_hintnames - IMAGEBASE
    dd 0, 0
    dd ntdll.dll - IMAGEBASE
    dd ntdll.dll_iat - IMAGEBASE
;terminator
    dd 0, 0, 0, 0, 0
_d
...
kernel32.dll_hintnames:
    ...
    dd 0
ntdll.dll_hintnames:
    dd hnZwAllocateVirtualMemory - IMAGEBASE
    dd 0
...
__imp__printf:
    ...
    dd 0
ntdll.dll_iat:
__imp__ZwAllocateVirtualMemory:
    dd hnZwAllocateVirtualMemory - IMAGEBASE
    dd 0
...
PAGE_EXECUTE_READWRITE equ 40h ; EXECUTE for EMET ;) 

setup:
    pushad
    pushf
    push PAGE_EXECUTE_READWRITE     ; ULONG Protect
    ...
    call [__imp__ZwAllocateVirtualMemory]
...
badstr db '"fail" as expected', 0ah, 0
