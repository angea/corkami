...
{gs} 				& {\tt DSE..} & {\tt GS} is eventually reset, on {\bf thread switch}, but stepping will clear it \\
pop ss			& {\tt .S...} & debuggers can't step right after {\tt pop SS} $\rightarrow$ {\tt TF} is visible via {\tt pushf} if stepping \\
