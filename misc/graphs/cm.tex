\newcommand{\sig}{\begin{flushright}\tiny{Ange Albertini, 2010, cc by 3.0}
 \url{http://corkami.googlecode.com/files/cm.pdf}\
 \href{https://corkami.googlecode.com/svn/trunk/misc/graphs/cm.tex}{source}\end{flushright}}
...
\begin{document}
\begin{center} DRAFT Counter-measures (anti-debugs, \ldots) cheat sheet \end{center}
