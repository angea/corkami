; a driver using undefined or lesser known privileged opcodes
...
istruc IMAGE_OPTIONAL_HEADER32
    ...
    at IMAGE_OPTIONAL_HEADER32.CheckSum,                  dd 0e980h
...
Msg db " * CR0: %X (normal) %X (invalid modRM) %X ('undefined' smsw <reg32>)", 0
_d
